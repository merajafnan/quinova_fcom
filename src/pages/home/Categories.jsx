...
const categorieItems = [
    ...
    { id: 3, title: "Dessert", des: "(48 dishes)", image: "/images/home/category/img3.png" },
            ...
            <div className='flex flex-col sm:flex-row flex-wrap gap-8 justify-around items-center mt-12'>
                {
                    categorieItems.map((item, i) => (
                        <div key={i} className='shadow-md rounded-md bg-white py-6 px-5 w-72 mx-auto text-center cursor-pointer hover:-translate-y-4 duration-300 transition-all'>
